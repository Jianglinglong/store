		...
		<div class="am-container header">
			...
			<div class="nav white">
				...
				<div class="search-bar pr">
					...
					<form action="home/listSearch.do" method="post">
						<input id="searchInput" name="ProName" type="text" placeholder="搜索" autocomplete="off"  onchange="out();">
						...
						<div class="am-u-sm-12 am-u-md-12">
	                  	<div class="theme-popover">														
							...
							<ul class="select">
									...
									<dl id="select1">
										<dt class="am-badge am-round">品牌</dt>	
										 ...
										 <div class="dd-conent">										
											...
											<c:forEach var="brand"  items="${brands }" begin="0" end="10">
												<dd><a>${brand }</a></dd>
											</c:forEach>
										 </div>
								...
								<li class="select-list">
									<dl id="select2">
										...
										<div class="dd-conent">
											<dd class="select-all selected"><a>全部</a></dd>
											<c:forEach var="breed"  items="${breeds }" begin="0" end="5">
												<dd class="1"><a>${breed }</a></dd>
											</c:forEach>
										</div>
									</dl>
								</li>
							...
							<div class="search-content">
								...
								<c:forEach var="good"  items="${searchList }">
									<li><a href="searchProduct/product.do?proId=${good.proId }">
										<div class="i-pic limit">
											<img src="${good.proImg }" />											
											<p class="title fl">${good.proName }</p>
											<p class="price fl">
												<b>¥</b>
												<strong>${good.proPrice }</strong>
											</p>
											<p class="number fl">
												销量<span>${good.proNum }</span>
											</p>
										</div>
										</a>
									</li>
					...
					<div class="footer">
						...
						<div class="footer-bd">
							<p>
								...
								<em>© 2015-2025 Hengwang.com 版权所有. 更多模板 <a href="Javascript:;" target="_blank" title=""></a> - Collect from <a href="Javascript:;" title="" target="_blank"></a></em>
							</p>
						</div>
					</div>
				</div>
...
<div class="theme-popover-mask"></div>
	...
	$(function() {
		...
		$("#searchInput").keyup(function() {
			...
			if (content !="") {
				$.get("home/searchReauesr.do",{"name":content},function(data) {
					$("#dtitles").html("");
					var json = eval("("+data+")");
					if (json.length > 0) {
						for ( var i = 0; i < json.length; i++) {
							$("#dtitles").append("<span onclick='setValue(this);'>"+json[i].proName+"</span>");
						}						
						$("#dtitles").slideDown(300);
					} else {
						$("#dtitles").slideUp(300);
					}
				});
