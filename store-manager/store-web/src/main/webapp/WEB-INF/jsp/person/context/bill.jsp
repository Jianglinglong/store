                ...
                <div class="block-income block  fn-left">
                    <h3 class="income-title block-title">
                        ...
                        <span class="desc ng-binding">
                                           <a href="javascript:getBillList();">查看支出明细</a>
                                         </span>
                    </h3>
                    ...
                    <div ng-class="shoppingChart" class="catatory-details  fn-hide shopping">
                        ...
                        <div class="catatory-detail fn-left">
                            ...
                            <ul>
                                <c:forEach items="${cost}" var="order">
                                <li class="ng-scope  delete-false">
                                    <div class="ng-scope">
                                        <a href="javascript:void(0);" class="text fn-left" title="${order.proName}">
                                            <span class="emoji-span ng-binding">${order.proName}</span>
                                            <span class="amount fn-right ng-binding">${order.proPrice}*${order.proNum}</span>
                                        </a>
                                    </div>
                                </li>
                                </c:forEach>
                                <li class="ng-scope delete-false">
                                    ...
                                    <div class="  ng-scope">
                                        <a href="javascript:;" class="text fn-left" title="羊毛毡底鞋垫">
