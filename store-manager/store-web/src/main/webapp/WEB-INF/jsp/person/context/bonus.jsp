            ...
            <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                <div class="cart-table-th">
                    ...
                    <div class="order-main">
                        <ul class="item-list">
                            <c:forEach items="${packets}" var="pakcet">
                                <c:if test="${pakcet.packetRemainMoney > 0}">
                                    <li class="td td-from">
                                        <div class="item-img">
                                        ...
                                        <div class="item-info">
                                            ...
                                            <a href="javascript:void(0);">
                                                <p>${pakcet.packetFrom}</p>
                                                <p class="info-little">
                                                    <span>红包初始面额：</span>¥${pakcet.packetTotalMoney}<span>元</span></p>
                                            </a>
                                    ...
                                    <li class="td td-remainderprice">
                                        <div class="item-remainderprice">
                                            <span>还剩</span>${pakcet.packetRemainMoney}<span>元</span>
                                        </div>
                                    </li>
