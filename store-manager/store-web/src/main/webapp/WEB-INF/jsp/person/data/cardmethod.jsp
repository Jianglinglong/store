			...
			<div class="main-wrap">
				...
				<form class="am-form am-form-horizontal">
					...
					<div class="am-form-group">
						...
						<div class="am-form-content" style="position: relative">
							<input type="tel" id="userIDcard" placeholder="请输入您的身份证信息">
					...
					<div class="am-form-group">
						...
						<div class="am-form-content" style="position: relative">
							<input type="tel" id="userBankID" placeholder="请输入要绑定的银行卡卡号">
							<div id="userBankID-message"
								style="line-height: 250%; position: absolute; width: 180px; height: 28px; left: 520px; top: 0px;">
								<font color=red>*</font>
							</div>
						</div>
					...
					<div class="am-form-group">
						...
						<div class="am-form-content" style="position: relative">
							<input type="tel" id="userPhone" placeholder="请输入此卡的预留手机号">
					...
					<div class="am-form-group code">
						...
						<div class="am-form-content" style="position: relative">
							...
							<div id="user-new-code-message"
								style="line-height: 250%; position: absolute; width: 180px; height: 28px; left: 520px; top: 0px;">
								<font color=red>*</font>
							</div>
						</div>
						<a class="btn" href="javascript:void(0);">
							<button id="sendMobileCode" class="am-btn am-btn-danger"
								onclick="sendMobileCode();">验证码</button>
						</a>
					</div>

					<div class="info-btn">
						<button class="am-btn am-btn-danger">开通协议并确定</button>
					</div>
