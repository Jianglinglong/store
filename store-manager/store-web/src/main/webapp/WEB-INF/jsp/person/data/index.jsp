...
<body>
					...
					<div class="wrap-list">
						<div class="m-user">
							...
							<div class="m-userinfo">
								...
								<div class="m-baseinfo">
									<a class="m-pic" href="personalData/list.do"> <img
										src="images/getAvatar.do.jpg">
									</a>
									<div class="m-info">
										<em class="s-name">小叮当</em>
										<div class="vip1">
											<a href="javascript:;"><span></span><em>会员专享</em></a>
										</div>
										<div class="safeText">
										...
										<div class="m-address">
											<a href="personalData/initAddress.do" class="i-trigger">收货地址<i
								...
								<div class="m-right">
									<div class="m-new">
										<a href="javascript:;"><i
											class="am-icon-dropbox  am-icon-md"
							...
							<div class="m-userproperty">
								...
								<p class="m-coupon">
									<a href="javascript:getCoupon();"> <em class="m-num">2</em>
							...
							<div class="wallet">
								...
								<p class="m-big squareS">
									<a href="javascript:;"> <i><img
											src="images/shopping.png" /></i> <span class="m-title">能购物</span>
									</a>
								</p>
								<p class="m-big squareA">
									<a href="javascript:;"> <i><img src="images/safe.png" /></i>
										<span class="m-title">够安全</span>
									</a>
								</p>
								<p class="m-big squareL">
									<a href="javascript:;"> <i><img src="images/profit.png" /></i>
						...
						<div class="m-order">
							...
							<ul>
								...
								<li><a href="order.html"><i><img
											src="images/comment.png" /></i><span>待评价<em class="m-num">3</em></span></a></li>
						...
						<div class="user-suggestion">
							...
							<div class="s-bar">
								<a href="consul/consul.do"><i class="s-icon"></i>意见反馈</a>
							</div>
						</div>
						...
						<div class="twoTab">
							<div class="twoTabModel Coupon">
								<h5 class="squareTitle">
									<a href="javascript:;"><span class="splitBorder"></span>优惠券<i
								...
								<div class="Box">
									<div class="CouponList">
										...
										<p class="brandName">
											<a href="javascript:;">ABC品牌499减50</a>
										</p>
										<p class="discount">
											满<span>499</span>元抵扣
										</p>
										<a href="javascript:;" class="btnReceive">立即领取</a>
									</div>
								</div>
							</div>
							<div class="twoTabModel credit">
								<h5 class="squareTitle">
									<a href="javascript:;"><span class="splitBorder"></span>积分商城<i
										class="am-icon-angle-right"></i></a>
								</h5>
								<div class="Box">
									<p class="countDown">
									...
									<div class="am-slider am-slider-default am-slider-carousel"
										...
										<ul class="am-slides">
											<li><a href="javascript:;"><img src="images/333.jpg" /></a></li>
											<li><a href="javascript:;"><img src="images/222.jpg" /></a></li>
											<li><a href="javascript:;"><img src="images/111.jpg" /></a></li>
											<li><a href="javascript:;"><img src="images/333.jpg" /></a></li>
											<li><a href="javascript:;"><img src="images/222.jpg" /></a></li>
											<li><a href="javascript:;"><img src="images/111.jpg" /></a></li>
										</ul>
				...
				<div class="wrap-right">
					...
					<div class="new-goods">
						...
						<div class="new-goods-info">
							<a class="shop-info" href="javascript:;">
							...
							<div class="am-slider am-slider-default am-slider-carousel"
								...
								<ul class="am-slides">
									<li><a><img class="am-thumbnail"
											src="images/EZA27501.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
									<li><a><img class="am-thumbnail"
											src="images/BxJk6.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
									<li><a><img class="am-thumbnail"
											src="images/Hxcag60.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
									<li><a><img class="am-thumbnail"
											src="images/youzi.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
									<li><a><img class="am-thumbnail"
											src="images/EZA27501.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
	...
	<div class="navCir">
		...
		<li><a href="home/javascript:;"><i class="am-icon-list"></i>分类</a></li>
		<li><a href="home/shopCart/listShopCart.do"><i
