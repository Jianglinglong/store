...
<script src="js/personalData/setpay.js"></script>
			...
			<div class="main-wrap">
				...
				<div class="m-progress">
					...
					<div id="u-progress-bar-total-steps-2"
						...
						<div id="u-progress-bar-inner" class="u-progress-bar-inner"></div>
					</div>
				</div>
				...
				<form class="am-form am-form-horizontal">
					...
					<div class="am-form-group code">
						...
						<a class="btn" href="javascript:void(0);" id="sendMobileCode">
							<button id="sendCode" onclick="sendMobileCode();"
								class="am-btn am-btn-danger">验证码</button>
						</a>
						<div id="verificationCode"
							style="line-height: 250%; position: absolute; width: 205px; height: 28px; left: 605px; top: 0px;">
							<font color=red>*</font>
						</div>
					</div>
					...
					<div class="am-form-group" style="position: relative;">
						...
						<div class="am-form-content">
							<input type="tel" id="user-pay-password" placeholder="6位数字">
						</div>
						<div id="payCode"
					...
					<div class="am-form-group" style="position: relative;">
						...
						<div id="cofirmPayCode"
							style="color: red; line-height: 250%; position: absolute; width: 205px; height: 28px; left: 605px; top: 0px;">*</div>
					</div>

					<div class="info-btn">
						<div id="preservation" class="am-btn am-btn-danger">保存修改</div>
					</div>
