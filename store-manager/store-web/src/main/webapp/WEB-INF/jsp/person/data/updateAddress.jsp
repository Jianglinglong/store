...
<script src="js/personalData/updateAddress.js"></script>
...
<script type="text/javascript">
	...
	var addr = ${address.addrAddress};
	$(function() {
		$("#pro").val(addr.p).change();
		$("#citys").val(addr.c).change();
		$("#area").val(addr.a);
		$("#userIntro").val(addr.detial);
	});
</script>
						...
						<div class="add-dress" style="position: relative">
							...
							<div class="am-cf am-padding">
								<div class="am-fl am-cf">
									<strong id="address-strong" class="am-text-danger am-text-lg">修改地址</strong> / 
									<small id="address-small">Update&nbsp;address</small>
								</div>
							</div>
							<hr />
