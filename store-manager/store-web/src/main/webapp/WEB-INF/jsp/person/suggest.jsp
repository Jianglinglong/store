		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<div class="suggestmain">
					...
					<input class="am-btn am-btn-danger anniu" type="button" value="提交"
						weight=15px height=120px background-color=red
						onclick="ShowDiv('test')" />
					<div id="test"
						style="display: none; position: absolute; left: 28%; top: 30%; width: 40%; height: 100px; background-color: #F5DEB3">
						<div>您反应的问题我们已收到，请稍等，我们将尽快处理！</div>
					</div>
					<p class="suggestTel">
