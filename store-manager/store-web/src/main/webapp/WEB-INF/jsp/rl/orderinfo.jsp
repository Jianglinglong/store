			...
			<div class="main-wrap">
				...
				<div class="user-orderinfo">
						...
						<div class="order-addresslist">
							<div class="order-address">
								...
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										<span class="title">收货地址：${order.orderAddr }</span>
					...
					<div class="order-infomain">
						...
						<c:forEach items="${orderInfo }" var="orderInfo" varStatus="ss">
							<div class="order-main">

								<div class="order-status3">
									<div class="order-title">
										<div class="dd-num">
											订单编号：<a href="javascript:;">${orderInfo.orderId }</a>
										</div>
										<span>成交时间：<h>
										...
										<div class="order-left">
											<ul class="item-list">
												...
												<li class="td td-price">
													<div class="item-price">${orderInfo.proPrice }</div>
												</li>
												<li class="td td-number">
													<div class="item-number">
														<span>×</span>${orderInfo.proNum }
													</div>
												</li>
