	    ...
	    $("#btn-up").click(function() { 
	    	...
	    	if(flag == true){
	    		if(confirm("确认添加！")){
	    			...
	    			var context = "<li class='user-addresslist '><span class='new-option-r'><i class='am-icon-check-circle'></i>默认地址</span><p class='new-tit new-p-re'><span class='new-txt'>"+valueName+"</span><span class='new-txt-rd2'>"+valuePhone+"</span></p><div class='new-mu_l2a new-p-re'><p  class='new-mu_l2cw'><span class='province'>"+proShow+"</span>&nbsp;<span class='city'>"+citysShow+"</span>&nbsp;<span class='dist'>"+areaShow+"</span>&nbsp;<span class='street'>"+detial+"</span></p></div><div class='new-addr-btn'><a href='addr/initUpdate.do?addrId=${address.addrId }'><i class='am-icon-edit'></i>编辑</a> <spanclass='new-addr-bar'>|</span> <a href='personalData/deleteAddress.do?addrId=${address.addrId }'><i class='am-icon-trash'></i>删除</a></div></li>";
	    		...
	    		/*	$.ajax({  
	    				    type: "POST",  
	    				    url:"personalData/addAddress.do",  
