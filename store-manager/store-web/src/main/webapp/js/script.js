...
//		var name = $(".fl").html();
//		//种类
//		var name1= $("#selectB").find('a').html();
//		if(name1){
//			name=name.trim();
//		}
//		$.get("searchProduct/secondsearch.do",{name1:name1,name:name},function(data){
...
//		var name = $(".fl").html();
//		//品牌
//		var name0= $("#selectA").find('a').html();
//		if(name){
//			name=name.trim();
//		}
//		$.get("searchProduct/secondsearch.do",{name0:name0,name:name},function(data){
//			$("#productList").html(data);
//		});
		$(this).remove();
